<template>
	<view class="measure">
		...
		<view class="measure" v-show="load === false">
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			_self.showRing("measureRing", _self.measureRingData, ['#2670f7', '#57c5d9', '#e65a40', '#f8841d']);
		},
		onReady() {
			let that = this;
			...
			setTimeout(function() {
				...
				that.measureRingData.animation = true;
				canvaRing.updateData(that.measureRingData);
			}, 2500);
		}
	}
</script>
